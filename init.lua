return {
    ...
    mappings = {
        ...
        n = {
            ...
            ["<leader>el"]={"<cmd>GitConflictListQf<CR>", desc = "List all conflict"},
            ["<leader>ec"]={"<cmd>GitConflictChooseOur<CR>", desc = "Select current changes"},
            ["<leader>ei"]={"<cmd>GitConflictChooseTheirs<CR>", desc = "Select incoming changes"},
            ["<leader>eb"]={"<cmd>GitConflictChooseBoth<CR>", desc = "Select both changes"},
            ["<leader>en"]={"<cmd>GitConflictChooseNone<CR>", desc = "Select none changes"},
            ["<leader>eN"]={"<cmd>GitConflictNextConflict<CR>", desc = "Move to next conflict"},
            ["<leader>eP"]={"<cmd>GitConflictPrevConflict<CR>", desc = "Move to previous conflict"},
            -- quick save
